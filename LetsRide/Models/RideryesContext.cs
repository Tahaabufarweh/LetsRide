...
{
    public partial class RideryesContext : DbContext
    {
        public RideryesContext()
        {
        }

        public RideryesContext(DbContextOptions<RideryesContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("data source=it-hadeel;initial catalog=Rideryes;Integrated Security=True;MultipleActiveResultSets=True;App=EntityFramework&quot;");
            }
        }
